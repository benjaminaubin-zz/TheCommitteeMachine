...
def run_SE(PW_choice,alpha,verbose,initialization_mode):
    SE = StateEvolution(K=K,PW_choice=PW_choice,alpha=alpha,channel='sign-sign',save_backup_running=False,seed=False,committee_symmetry=True,print_running=verbose,initialization_mode=initialization_mode) 
    SE.initialization()
    SE.SE_iteration()
    return SE
